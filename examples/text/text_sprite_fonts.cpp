...
int main(void)
{
    ...
    raylib::Window w(screenWidth, screenHeight, "raylib [text] example - sprite fonts usage");
    ...
    raylib::Vector2 fontPosition1(screenWidth/2 - MeasureTextEx(font1, msg1, font1.baseSize, -3).x/2,
                              screenHeight/2 - font1.baseSize/2 - 80);

    raylib::Vector2 fontPosition2(screenWidth/2 - MeasureTextEx(font2, msg2, font2.baseSize, -2).x/2,
                              screenHeight/2 - font2.baseSize/2 - 10);

    raylib::Vector2 fontPosition3(screenWidth/2 - MeasureTextEx(font3, msg3, font3.baseSize, 2).x/2,
